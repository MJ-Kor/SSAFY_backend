...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public List<BoardDto> searchArticle(String key, String search_word) throws Exception {
		// TODO : BoardDaoImpl의 searchArticle 호출
		return boardDao.searchArticle(key, search_word);
	}
