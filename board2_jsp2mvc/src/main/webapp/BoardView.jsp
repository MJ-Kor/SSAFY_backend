...
BoardDto boardDto = BoardDaoImpl.getInstance().viewArticle(Integer.parseInt(articleno));
%>
<!DOCTYPE html>
<html lang="ko">
  <head>
  ...
  <body>
    ...
    <script>
      ...
      document.querySelector("#btn-mv-modify").addEventListener("click", function () {
        alert("글수정하자!!!");
        location.href = "/board2/movemodify.jsp?articleno=" + <%= articleno %>;
      });
      document.querySelector("#btn-delete").addEventListener("click", function () {
        alert("글삭제하자!!!");
        location.href = "/board2/BoardDelete.jsp?articleno=" + <%= articleno %>;
      });
    </script>
  </body>
</html>
